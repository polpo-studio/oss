...
Here's an example of how to use [QOR OSS](https://github.com/polpo-studio/oss) with S3. After initializing the s3 storage, The functions in the interface are available.
